...
?>
<?php get_header(); ?>
<?php $page_layout = get_post_meta( get_the_ID(), '_mospress_page_layout', true )? get_post_meta( get_the_ID(), '_mospress_page_layout', true ) : $mosportfolio_options['blog-archive-layout']; ?>
		...
		<div class="container">
			...
			<?php endif; ?>
				...
				<?php endif;?>
					...
					<?php if ($mosportfolio_options['single-blog-comment']) : ?>
						<?php if ($mosportfolio_options['single-blog-comment-style'] == 'fb') : ?>
