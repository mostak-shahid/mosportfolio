<?php
//Add theme setup
if ( ! function_exists( 'mosportfolio_setup' ) ) :
	function mosportfolio_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'mosportfolio'),
			'mobilemenu' => __('Mobile Menu', 'mosportfolio'),
		));
...
add_action( 'after_setup_theme', 'mosportfolio_setup' );