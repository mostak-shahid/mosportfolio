...
//with template 
//mosportfolio_add_page('puppy-home', 'Puppy Home', 'templates/template-puppies-home.php');
//without template
//mosportfolio_add_page('csvimport', 'CSV Import', 'default');
...
function mobile_menu ($value) {
    ...
    <?php foreach ( $value as $key => $value ) : ?>
        ...
        <?php elseif ( $key == 'phone' ) : ?>
            <div class="<?php echo $bc ?>">
                <a class="small-phone" href="tel:<?php echo preg_replace('/[^0-9]/', '', $contact_phone[0]) ?>"><i class="fa fa-phone-square"></i><span class="text"> Call Me</span></a>
            </div>
            
        <?php elseif ( $key == 'email' ) : ?>
            <div class="<?php echo $bc ?>">
                <a class="small-email" href="mailto:<?php echo $contact_email[0];?>"><i class="fa fa-envelope"></i><span class="text">Email Me</span></a> 
            </div>
        <?php endif; ?>
    <?php endforeach; ?>
    </div>
