<?php
//Add widgets area
function mosportfolio_widgets_init(){
	global $mosportfolio_options;
	if ($mosportfolio_options['sections-sidebar-custom']) : 
		foreach ($mosportfolio_options['sections-sidebar-custom'] as $name) {
			$id = strtolower(str_replace(' ', '_', $name));
			register_sidebar(array(
				'id' => $id,
				'name' => __($name, 'mosportfolio'),
				//'description' => __('Add widgets here to appear in your Left SideBar', 'mosportfolio'),
	...
	register_sidebar(array(
		'id' => 'sidebar',
		'name' => __('Sidebar for Post', 'mosportfolio'),
		//'description' => __('Add widgets here to appear in your Left SideBar', 'mosportfolio'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar(array(
		'id' => 'sidebar-page',
		'name' => __('Sidebar for Page', 'mosportfolio'),
		//'description' => __('Add widgets here to appear in your Left SideBar', 'mosportfolio'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar(array(
		'id' => 'footer_1',
		'name' => __('Footer Column 1', 'mosportfolio'),
		'description' => __('Add widgets here to appear in your Footer Column 1', 'mosportfolio'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
	...
	register_sidebar(array(
		'id' => 'footer_2',
		'name' => __('Footer Column 2', 'mosportfolio'),
		'description' => __('Add widgets here to appear in your Footer Column 2', 'mosportfolio'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'before_title' => '<h2 class="widget-title">',
		'after_title' => '</h2>',
		'after_widget' => '</div>'
	...
	register_sidebar(array(
		'id' => 'footer_3',
		'name' => __('Footer Column 3', 'mosportfolio'),
		'description' => __('Add widgets here to appear in your Footer Column 3', 'mosportfolio'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'before_title' => '<h2 class="widget-title">',
		'after_title' => '</h2>',
		'after_widget' => '</div>'
	...
	register_sidebar(array(
		'id' => 'footer_4',
		'name' => __('Footer Column 4', 'mosportfolio'),
		'description' => __('Add widgets here to appear in your Footer Column 4', 'mosportfolio'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'before_title' => '<h2 class="widget-title">',
		'after_title' => '</h2>',
		'after_widget' => '</div>'
...
add_action('widgets_init', 'mosportfolio_widgets_init');
	...
	public function widget( $args, $instance ) {
		...
		?>
			<div class="mos_contact">
				...
				<?php endif; ?>
				<p class="widgets-map"><a class="map-holder" href="<?php echo $instance['map_url'] ?>" target="_mosportfolio" rel="noopener noreferrer"><img class="alignnone wp-image-434 size-full img-responsive img-center" src="<?php echo $instance['map_img'] ?>" alt="Location"></a></p>
			</div>
		<?php echo $args['after_widget'] ?>
<?php
	}
