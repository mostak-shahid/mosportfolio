<?php
function mosportfolio_metaboxes() {
    global $container_list, $section_list, $mosportfolio_options;
    $sections_enable = $mosportfolio_options['page-layout-settings']['Enabled'];
    $sections_disable = $mosportfolio_options['page-layout-settings']['Disabled'];
    $layout = ( $mosportfolio_options['general-page-layout'] ) ? $mosportfolio_options['general-page-layout'] : 'ns';    
    $sidebar = ( $mosportfolio_options['sections-sidebar-custom'] ) ? $mosportfolio_options['sections-sidebar-custom'] : '';
    ...
    $page_settings->add_field( array( 
        ...
        'default' => $mosportfolio_options['general-page-layout'], 
    ));
...
add_action('cmb2_admin_init', 'mosportfolio_metaboxes');