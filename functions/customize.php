...
function mosportfolio_customize_register( $wp_customize ){
...
add_action('customize_register', 'mosportfolio_customize_register'); 
//Output Customize CSS
function mosportfolio_customize_css(){?>
    <style type="text/css">
        a:link,
        a:visited {
...
<?php }
add_action('wp_head', 'mosportfolio_customize_css');
