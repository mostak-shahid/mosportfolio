		...
		*/
		...
		<?php if($page_layout != 'ns') : ?>
			...
			<?php endif; ?>
				...
				<?php 
				/*
				* action_before_contact_page_form hook
				* @hooked contact_info 10
				*/
				do_action( 'action_before_contact_page_form', $page_details );
				?>
				<?php 
				/*
				* action_contact_page_form hook
				* @hooked form_generator 10 (output .container)
				*/
				do_action( 'action_contact_page_form', $page_details );
				?>
