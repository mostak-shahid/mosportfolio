jQuery(document).ready(function($) {    
    ...
    function show_meta_boxes(page_template) {
        if(page_template == 'page-template/lightbox-gallery-page.php') {
            $('#_mosportfolio_gallery_details').show();
        } else {
           $('#_mosportfolio_gallery_details').hide();
        }
        if(page_template == 'page-template/lightbox-multy-gallery-page.php') {
            $('#_mosportfolio_multy_gallery_details').show();
        } else {
           $('#_mosportfolio_multy_gallery_details').hide(); 
        }
        if(page_template == 'page-template/offer-page.php') {
            $('#_mosportfolio_offer_details').show();
        } else {
           $('#_mosportfolio_offer_details').hide();
        }
        if(page_template == 'page-template/link-gallery-page.php') {
            $('#_mosportfolio_link_gallery_details').show();
        } else {
           $('#_mosportfolio_link_gallery_details').hide();
        }
        if(page_template == 'page-template/group-tab-page.php') {
            $('#_mosportfolio_tab_group_details').show();
        } else {
           $('#_mosportfolio_tab_group_details').hide(); 
        }
        if(page_template == 'page-template/home-page.php') {
            $('#_mosportfolio_page_settings').hide();
        } else {
           $('#_mosportfolio_page_settings').show();
        }
    }
}); 
