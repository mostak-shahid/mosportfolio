jQuery(document).ready(function($) {
    ...
    $(".small-menu, .mobile-menu a").click(function() {
	...
	$('iframe').load( function() {
	    $('iframe').contents().find("head").append("<style type='text/css'> .tl-credit, .tl-caption{width: 50% !important;}.tl-credit{float: left}.tl-caption{float: right}  </style>");
	});
