...
$animation = $mosportfolio_options['sections-button-animation'];
$animation_delay = $mosportfolio_options['sections-button-animation-delay'];
$title = $mosportfolio_options['sections-button-title'];
$content = $mosportfolio_options['sections-button-content'];
$buttons = $mosportfolio_options['sections-button-slides'];
$gap = $mosportfolio_options['sections-button-gap'][1];
