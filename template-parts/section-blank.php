...
$animation = $mosportfolio_options['sections-blank-animation'];
$animation_delay = ( $mosportfolio_options['sections-blank-animation-delay'] ) ? $mosportfolio_options['sections-blank-animation-delay'] : 0;
$title = $mosportfolio_options['sections-blank-title'];
$content = $mosportfolio_options['sections-blank-content'];
