...
$title = $mosportfolio_options['sections-product-title'];
$content = $mosportfolio_options['sections-product-content'];
$slides = $mosportfolio_options['sections-product-slides'];
