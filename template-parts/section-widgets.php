...
$title = $mosportfolio_options['sections-widgets-title'];
$content = $mosportfolio_options['sections-widgets-content'];
$layout = $mosportfolio_options['sections-widgets-layout'];
