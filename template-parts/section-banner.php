...
$select = $mosportfolio_options['sections-banner-select'];
$slides = $mosportfolio_options['sections-banner-details'];
$shortcode = $mosportfolio_options['sections-banner-shortcode'];
$n = 1;
...
<section id="section-banner">
	...
	<?php else : ?>
		...
		<?php foreach ($slides as $slide) : ?>
			<div class="wrapper">
				<?php echo wp_get_attachment_image( $slide["attachment_id"], 'full', false, array( 'class' => 'img-responsive img-banner', 'alt' => $alt_tag['inner'] . $slide["title"] )) ?>
